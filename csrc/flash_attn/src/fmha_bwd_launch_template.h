...
void run_fmha_bwd_loop(FMHA_dgrad_params &params, cudaStream_t stream, const bool configure) {
    ...
    if (has_attn_mask) {
        if (has_attn_bias) {
            ...
            BOOL_SWITCH(is_dropout, IsDropoutConst, ({
                auto kernel = params.is_causal
                    ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, true, true>
                    : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, true, true>;
                if (params.seqlen_k == blocksize_c) {
                    kernel = params.is_causal
                        ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, true, true, /*loop_steps=*/1>
                        : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, true, true, /*loop_steps=*/1>;
                } else if (params.seqlen_k == blocksize_c * 2) {
                    kernel = params.is_causal
                        ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, true, true, /*loop_steps=*/2>
                        : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, true, true, /*loop_steps=*/2>;
                }
                auto kernel_seqparallel = params.is_causal
                    ? &fmha_bwd_q_dk_dv_loop_seqparallel_kernel<Kernel_traits, IsDropoutConst, true, true, true>
                    : &fmha_bwd_q_dk_dv_loop_seqparallel_kernel<Kernel_traits, IsDropoutConst, false, true, true>;
            ...
            BOOL_SWITCH(is_dropout, IsDropoutConst, ({
                auto kernel = params.is_causal
                    ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, true, false>
                    : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, true, false>;
                if (params.seqlen_k == blocksize_c) {
                    kernel = params.is_causal
                        ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, true, false, /*loop_steps=*/1>
                        : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, true, false, /*loop_steps=*/1>;
                } else if (params.seqlen_k == blocksize_c * 2) {
                    kernel = params.is_causal
                        ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, true, false, /*loop_steps=*/2>
                        : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, true, false, /*loop_steps=*/2>;
                }
                auto kernel_seqparallel = params.is_causal
                    ? &fmha_bwd_q_dk_dv_loop_seqparallel_kernel<Kernel_traits, IsDropoutConst, true, true, false>
                    : &fmha_bwd_q_dk_dv_loop_seqparallel_kernel<Kernel_traits, IsDropoutConst, false, true, false>;
                if( smem_size_dq_dk_dv >= 48 * 1024 ) {
                    FMHA_CHECK_CUDA(cudaFuncSetAttribute(
                        kernel, cudaFuncAttributeMaxDynamicSharedMemorySize, smem_size_dq_dk_dv));
                    FMHA_CHECK_CUDA(cudaFuncSetAttribute(
        ...
        if (has_attn_bias)  {
            ...
            BOOL_SWITCH(is_dropout, IsDropoutConst, ({
                auto kernel = params.is_causal
                    ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, false, true>
                    : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, false, true>;
                if (params.seqlen_k == blocksize_c) {
                    kernel = params.is_causal
                        ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, false, true, /*loop_steps=*/1>
                        : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, false, true, /*loop_steps=*/1>;
                } else if (params.seqlen_k == blocksize_c * 2) {
                    kernel = params.is_causal
                        ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, false, true, /*loop_steps=*/2>
                        : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, false, true, /*loop_steps=*/2>;
                }
                auto kernel_seqparallel = params.is_causal
                    ? &fmha_bwd_q_dk_dv_loop_seqparallel_kernel<Kernel_traits, IsDropoutConst, true, false, true>
                    : &fmha_bwd_q_dk_dv_loop_seqparallel_kernel<Kernel_traits, IsDropoutConst, false, false, true>;
                if( smem_size_dq_dk_dv >= 48 * 1024 ) {
                    FMHA_CHECK_CUDA(cudaFuncSetAttribute(
                        kernel, cudaFuncAttributeMaxDynamicSharedMemorySize, smem_size_dq_dk_dv));
                    FMHA_CHECK_CUDA(cudaFuncSetAttribute(
            ...
            BOOL_SWITCH(is_dropout, IsDropoutConst, ({
                auto kernel = params.is_causal
                    ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, false, false>
                    : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, false, false>;
                if (params.seqlen_k == blocksize_c) {
                    kernel = params.is_causal
                        ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, false, false, /*loop_steps=*/1>
                        : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, false, false, /*loop_steps=*/1>;
                } else if (params.seqlen_k == blocksize_c * 2) {
                    kernel = params.is_causal
                        ? &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, true, false, false, /*loop_steps=*/2>
                        : &fmha_bwd_dq_dk_dv_loop_kernel<Kernel_traits, IsDropoutConst, false, false, false, /*loop_steps=*/2>;
                }
                auto kernel_seqparallel = params.is_causal
                    ? &fmha_bwd_q_dk_dv_loop_seqparallel_kernel<Kernel_traits, IsDropoutConst, true, false, false>
                    : &fmha_bwd_q_dk_dv_loop_seqparallel_kernel<Kernel_traits, IsDropoutConst, false, false, false>;
                if( smem_size_dq_dk_dv >= 48 * 1024 ) {
                    FMHA_CHECK_CUDA(cudaFuncSetAttribute(
                        kernel, cudaFuncAttributeMaxDynamicSharedMemorySize, smem_size_dq_dk_dv));
                    FMHA_CHECK_CUDA(cudaFuncSetAttribute(
